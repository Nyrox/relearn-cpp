...
static void  GL_APIENTRY _impl_glGetPointervKHR(GLenum pname, void** params) {
    _glptr_glGetPointervKHR = (PFN_glGetPointervKHR)GalogenGetProcAddress("glGetPointervKHR");
    _glptr_glGetPointervKHR(pname, params);
}
PFN_glGetPointervKHR _glptr_glGetPointervKHR = _impl_glGetPointervKHR;

static void  GL_APIENTRY _impl_glGetObjectPtrLabelKHR(const void* ptr, GLsizei bufSize, GLsizei* length, GLchar* label) {
    _glptr_glGetObjectPtrLabelKHR = (PFN_glGetObjectPtrLabelKHR)GalogenGetProcAddress("glGetObjectPtrLabelKHR");
    _glptr_glGetObjectPtrLabelKHR(ptr, bufSize, length, label);
}
PFN_glGetObjectPtrLabelKHR _glptr_glGetObjectPtrLabelKHR = _impl_glGetObjectPtrLabelKHR;

static void  GL_APIENTRY _impl_glObjectPtrLabelKHR(const void* ptr, GLsizei length, const GLchar* label) {
    _glptr_glObjectPtrLabelKHR = (PFN_glObjectPtrLabelKHR)GalogenGetProcAddress("glObjectPtrLabelKHR");
    _glptr_glObjectPtrLabelKHR(ptr, length, label);
}
PFN_glObjectPtrLabelKHR _glptr_glObjectPtrLabelKHR = _impl_glObjectPtrLabelKHR;

static void  GL_APIENTRY _impl_glObjectLabelKHR(GLenum identifier, GLuint name, GLsizei length, const GLchar* label) {
    _glptr_glObjectLabelKHR = (PFN_glObjectLabelKHR)GalogenGetProcAddress("glObjectLabelKHR");
    _glptr_glObjectLabelKHR(identifier, name, length, label);
}
PFN_glObjectLabelKHR _glptr_glObjectLabelKHR = _impl_glObjectLabelKHR;

static void  GL_APIENTRY _impl_glPopDebugGroupKHR() {
    _glptr_glPopDebugGroupKHR = (PFN_glPopDebugGroupKHR)GalogenGetProcAddress("glPopDebugGroupKHR");
    _glptr_glPopDebugGroupKHR();
}
PFN_glPopDebugGroupKHR _glptr_glPopDebugGroupKHR = _impl_glPopDebugGroupKHR;

static void  GL_APIENTRY _impl_glGetObjectLabelKHR(GLenum identifier, GLuint name, GLsizei bufSize, GLsizei* length, GLchar* label) {
    _glptr_glGetObjectLabelKHR = (PFN_glGetObjectLabelKHR)GalogenGetProcAddress("glGetObjectLabelKHR");
    _glptr_glGetObjectLabelKHR(identifier, name, bufSize, length, label);
}
PFN_glGetObjectLabelKHR _glptr_glGetObjectLabelKHR = _impl_glGetObjectLabelKHR;

static void  GL_APIENTRY _impl_glPushDebugGroupKHR(GLenum source, GLuint id, GLsizei length, const GLchar* message) {
    _glptr_glPushDebugGroupKHR = (PFN_glPushDebugGroupKHR)GalogenGetProcAddress("glPushDebugGroupKHR");
    _glptr_glPushDebugGroupKHR(source, id, length, message);
}
PFN_glPushDebugGroupKHR _glptr_glPushDebugGroupKHR = _impl_glPushDebugGroupKHR;

static GLuint GL_APIENTRY _impl_glGetDebugMessageLogKHR(GLuint count, GLsizei bufSize, GLenum* sources, GLenum* types, GLuint* ids, GLenum* severities, GLsizei* lengths, GLchar* messageLog) {
    _glptr_glGetDebugMessageLogKHR = (PFN_glGetDebugMessageLogKHR)GalogenGetProcAddress("glGetDebugMessageLogKHR");
    return _glptr_glGetDebugMessageLogKHR(count, bufSize, sources, types, ids, severities, lengths, messageLog);
}
PFN_glGetDebugMessageLogKHR _glptr_glGetDebugMessageLogKHR = _impl_glGetDebugMessageLogKHR;

static void  GL_APIENTRY _impl_glDebugMessageCallbackKHR(GLDEBUGPROCKHR callback, const void* userParam) {
    _glptr_glDebugMessageCallbackKHR = (PFN_glDebugMessageCallbackKHR)GalogenGetProcAddress("glDebugMessageCallbackKHR");
    _glptr_glDebugMessageCallbackKHR(callback, userParam);
}
PFN_glDebugMessageCallbackKHR _glptr_glDebugMessageCallbackKHR = _impl_glDebugMessageCallbackKHR;

static void  GL_APIENTRY _impl_glDebugMessageControlKHR(GLenum source, GLenum type, GLenum severity, GLsizei count, const GLuint* ids, GLboolean enabled) {
    _glptr_glDebugMessageControlKHR = (PFN_glDebugMessageControlKHR)GalogenGetProcAddress("glDebugMessageControlKHR");
    _glptr_glDebugMessageControlKHR(source, type, severity, count, ids, enabled);
}
PFN_glDebugMessageControlKHR _glptr_glDebugMessageControlKHR = _impl_glDebugMessageControlKHR;
...
static void  GL_APIENTRY _impl_glDebugMessageInsertKHR(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar* buf) {
    _glptr_glDebugMessageInsertKHR = (PFN_glDebugMessageInsertKHR)GalogenGetProcAddress("glDebugMessageInsertKHR");
    _glptr_glDebugMessageInsertKHR(source, type, id, severity, length, buf);
}
PFN_glDebugMessageInsertKHR _glptr_glDebugMessageInsertKHR = _impl_glDebugMessageInsertKHR;
